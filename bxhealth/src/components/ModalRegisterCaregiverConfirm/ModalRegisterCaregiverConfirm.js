...
// Styles
import './ModalRegisterCaregiverConfirm.scss';

// Data
import data from './data.json';

class ModalRegisterCaregiverConfirm extends React.Component {
  constructor() {
    super();
    this.state = {
      isOpen: false
  ...
  render() {
    return (
      <div>
        <Modal isOpen={this.state.isOpen} toggle={this.toggle.bind(this)} className="modal-xl modal-register-caregiver-confirm">
